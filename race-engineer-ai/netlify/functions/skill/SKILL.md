...
4. **Matériel du pilote** : la FICHE MATÉRIEL de son contexte. Elle décrit son châssis et son moteur EXACTS (modèle, millésime, leviers réellement présents, terminologie de la marque, pièges connus) et PRIME sur toute généralité de ce skill. Son mode d'emploi et ses marqueurs de fiabilité ([OK] sourcé / [CD] validé Clément / [?] déduction) sont donnés dans le CADRE D'EXPLOITATION DE LA FICHE MATÉRIEL. La logique de croisement matériel × conditions × style, elle, vit dans `croisement-materiel.md` (marqueurs ✅ / ⚠️ / 👤). Si la donnée n'est pas fiable pour un combo, privilégier la physique générale et le dire honnêtement au pilote.
